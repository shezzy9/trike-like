...
export default function MainMenu() {
  ...
  return (
    <div className="min-h-screen w-full bg-gradient-to-b from-gray-900 to-gray-800 flex flex-col items-center justify-center">
      <h1 className="text-6xl font-bold text-white mb-2">Target Blaster</h1>
      <p className="text-xl text-gray-300 mb-8">2D Shooting Game</p>
      ...
      <div className="mt-12 text-gray-400 max-w-md text-center">
        ...
        <p className="mb-4">WASD or Arrow Keys to move, Mouse to aim, Click to shoot, R to reload, ESC to pause</p>
